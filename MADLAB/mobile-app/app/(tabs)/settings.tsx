...
export default function Settings() {
  ...
  const handlePickFromGallery = async () => {
    ...
    if (status !== "granted") {
      Alert.alert("Permission Required", "Please allow photo library access to pick an avatar.");
      return;
    }
              ...
              <View className="gap-6">
                ...
                <View className="p-5 bg-white/5 border border-white/10 rounded-3xl gap-4 items-center">
                  ...
                  >
                    ...
                    <Text className="text-white/60 text-xs font-semibold">Pick from Gallery</Text>
                  </TouchableOpacity>
                </View>
